...
var Modal = (0, import_react12.forwardRef)((_ref, ref) => {
  ...
  if (Transition2) {
    dialog = (0, import_jsx_runtime9.jsx)(Transition2, {
      appear: true,
      unmountOnExit: true,
      in: !!show,
      onExit,
  ...
  if (backdrop) {
    ...
    if (BackdropTransition2) {
      backdropElement = (0, import_jsx_runtime9.jsx)(BackdropTransition2, {
        appear: true,
        in: !!show,
...
var NavbarCollapse = React14.forwardRef(({
  children,
  bsPrefix,
  ...props
}, ref) => {
  ...
  return (0, import_jsx_runtime16.jsx)(Collapse_default, {
...
var NavbarToggle = React15.forwardRef(({
  bsPrefix,
  className,
  children,
  label,
  ...
  return (0, import_jsx_runtime17.jsx)(Component, {
    ...
    onClick: handleClick,
    "aria-label": label,
    className: (0, import_classnames8.default)(className, bsPrefix, !expanded && "collapsed"),
    children: children || (0, import_jsx_runtime17.jsx)("span", {
...
//# sourceMappingURL=chunk-VVTSJJZM.js.map
